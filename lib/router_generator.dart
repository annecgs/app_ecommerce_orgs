  ...
  static Route<dynamic> generateRoute(RouteSettings settings){
    ...
    switch(settings.name){
      ...
      case 'producer-details':
        if(args is Producer){
          return MaterialPageRoute(builder: (_) => ProducerDetailsScreen(producer: args));
        }
        return _errorRoute();

      case 'package-details':
        if(args is Map){
          return MaterialPageRoute(builder: (_) => PackageDetailsScreen(package: args['package'], producer: args['producer'],));
        }
        return _errorRoute();
